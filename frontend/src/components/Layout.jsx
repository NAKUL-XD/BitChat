    ...
    <div className={`min-h-screen ${theme === 'dark' ? "bg-[#111b21] text-white" : "bg-gray-100 text-black"} flex relative`}>
      ...
      {isThemeDialogOpen && (
        <div className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50'>
          <div className={`${theme === 'dark' ? "bg-[#202c33} text-white" : "bg-white text-black"}p-6 rounded-lg shadow-lg msx-w-sm w-full `}>
            ...
            <button className='mt-6 w-full bg-blue-500 text-white hover:bg-blue-600 transition duration-200' onClick={toggleThemeDialog}>
              Close
      ...
      {isStatusPreviewOpen && (
        <div className='fixed inset-0 f;ex items-center justify-center bg-black bg-opacity-50 z-50'>
